<nav class="navbar navbar-expand-sm navbar-dark fixed-top">
    <div class="container-fluid">
        <a class="navbar-brand me-auto" style="margin-right:3px;" href="../../General/views/index.php">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav me-auto" style="font-size: 13px!important; margin-left: 12px;">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu custom-dropdown drop2" aria-labelledby="navbarDropdown">
                        <div class="dropdown-content d-flex">
                            <ul class="navigation">
                                <h2>Investment</h2>
            ...
            <!-- Right-aligned Links -->
            <ul class="navbar-nav ms-auto" style="font-size: 13px!important;">
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#Booking">
                        <button class="btn btn-sm btn-primary book-now-btn" style="font-size: 13px!important;">Book Now</button>
                    </a>
                </li>
            </ul>
        </div>
