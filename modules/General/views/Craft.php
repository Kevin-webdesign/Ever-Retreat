...
// Get page content
$page = $db->query("SELECT * FROM tourism_content WHERE page_key = 'craft'")->fetch(PDO::FETCH_ASSOC);
...
<body>
    <style>
        ...
        .cta-button { display: inline-block; background-color: #007BFF; color: white; padding: 10px 20px; text-decoration: none; border-radius: 4px; margin-top: 15px; align-self: flex-start; }
