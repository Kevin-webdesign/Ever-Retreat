...
<?php
    ...
    $accommodations = $db->query("SELECT * FROM accommodations WHERE is_active = TRUE ORDER BY display_order LIMIT 1")->fetch(PDO::FETCH_ASSOC);
